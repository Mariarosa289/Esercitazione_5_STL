...
bool ImportCell0Ds(PolygonalMesh& mesh)
{
    ...
    for (const string& line : listLines)
    {
        ...
        char separator; // To handle the ';' in csv

        converter >> id >> separator >> marker >> separator >> x >> separator >> y;
...
bool ImportCell1Ds(PolygonalMesh& mesh)
{
    ...
    for (const string& line : listLines)
    {
        ...
        converter >> id >> separator >> marker >> separator >> fromId >> separator >> toId;

        mesh.Cell1DsId.push_back(id);
        mesh.Cell1DsExtrema(0, id) = fromId;
        mesh.Cell1DsExtrema(1, id) = toId;
